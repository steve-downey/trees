...
//
// Design:
//   - BENCHMARK:          operation IS the construction (e.g. push N times from
//   empty)
...
auto make_pq_vec(int n) -> std::vector<int> {
    ...
    std::generate(v.begin(), v.end(),
                  [&] { return static_cast<int>(rng() % 100'000); });
    return v;
}

auto make_pq(int n) -> PQ { return PQ::from_values(make_pq_vec(n)); }
...
auto make_idx(int n) -> Idx { return Idx::from_intervals(make_ivl_vec(n)); }

auto brute_query_point(const std::vector<Ivl> &intervals, std::size_t point)
    -> std::vector<int> {
    std::vector<int> out;
...
auto brute_query_overlap(const std::vector<Ivl> &intervals, std::size_t lo,
                         std::size_t hi) -> std::vector<int> {
    std::vector<int> out;
    for (const auto &iv : intervals)
...
TEST_CASE("Bench Std: RandomAccess vs vector") {
    ...
    BENCHMARK_ADVANCED("FT5 at_random N=1000")(
    ...
    BENCHMARK_ADVANCED("vector at_random N=1000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("FT5 at_random N=100000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("vector at_random N=100000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("FT5 insert_mid N=100")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(100);
        meter.measure([&] { return s.insert(50, 42).size(); });
    };
    BENCHMARK_ADVANCED("vector insert_mid N=100")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(100);
        meter.measure([&] {
            auto w = v;
    ...
    BENCHMARK_ADVANCED("FT5 insert_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(10'000);
        meter.measure([&] { return s.insert(5000, 42).size(); });
    };
    BENCHMARK_ADVANCED("vector insert_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("FT5 insert_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(100'000);
        meter.measure([&] { return s.insert(50'000, 42).size(); });
    };
    BENCHMARK_ADVANCED("vector insert_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(100'000);
        meter.measure([&] {
            auto w = v;
    ...
    BENCHMARK_ADVANCED("FT5 erase_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(10'000);
        meter.measure([&] { return s.erase(5000).size(); });
    };
    BENCHMARK_ADVANCED("vector erase_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(10'000);
        meter.measure([&] {
            auto w = v;
    ...
    BENCHMARK_ADVANCED("FT5 erase_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(100'000);
        meter.measure([&] { return s.erase(50'000).size(); });
    };
    BENCHMARK_ADVANCED("vector erase_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(100'000);
        meter.measure([&] {
            auto w = v;
    ...
    BENCHMARK_ADVANCED("FT5 concat N=10000")(
        Catch::Benchmark::Chronometer meter) {
        ...
        meter.measure([&] {
            ...
            // TODO: add a concat(a, b) method to the wrapper for O(log N)
            // concat
        });
    };
    BENCHMARK_ADVANCED("vector concat N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("FT5 snapshot N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(10'000);
        meter.measure([&] {
    ...
    BENCHMARK_ADVANCED("vector snapshot N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(10'000);
        meter.measure([&] {
            auto copy = v; // O(N)
    ...
    BENCHMARK_ADVANCED("FT5 snapshot N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(100'000);
        meter.measure([&] { return (s).size(); });
    };
    BENCHMARK_ADVANCED("vector snapshot N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(100'000);
        meter.measure([&] {
            auto copy = v;
...
TEST_CASE("Bench Std: Rope vs string") {
    ...
    BENCHMARK_ADVANCED("Rope insert_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto r = make_rope(10'000);
        meter.measure([&] { return r.insert(5000, "hello").size_bytes(); });
    };
    BENCHMARK_ADVANCED("string insert_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("Rope insert_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto r = make_rope(100'000);
        meter.measure([&] { return r.insert(50'000, "hello").size_bytes(); });
    };
    BENCHMARK_ADVANCED("string insert_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("Rope erase_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto r = make_rope(10'000);
        meter.measure([&] { return r.erase(5000, 5).size_bytes(); });
    };
    BENCHMARK_ADVANCED("string erase_mid N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = std::string(10'000, 'x');
        meter.measure([&] {
            auto t = s;
    ...
    BENCHMARK_ADVANCED("Rope erase_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto r = make_rope(100'000);
        meter.measure([&] { return r.erase(50'000, 5).size_bytes(); });
    };
    BENCHMARK_ADVANCED("string erase_mid N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = std::string(100'000, 'x');
        meter.measure([&] {
            auto t = s;
    ...
    BENCHMARK_ADVANCED("Rope concat_via_insert N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("string concat N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("Rope snapshot N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto r = make_rope(100'000);
        meter.measure([&] { return r.size_bytes(); }); // copy is O(1)
    };
    BENCHMARK_ADVANCED("string snapshot N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = std::string(100'000, 'x');
        meter.measure([&] {
            auto copy = s;
    ...
    BENCHMARK_ADVANCED("Rope to_string N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto r = make_rope(10'000);
        meter.measure([&] { return r.to_string().size(); });
    };
    BENCHMARK_ADVANCED("string noop N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = std::string(10'000, 'x');
        meter.measure([&] { return s.size(); });
    };
...
TEST_CASE("Bench Std: PQ vs std::priority_queue") {
    ...
    BENCHMARK_ADVANCED("FT5 PQ pop_min_all N=1000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("std PQ pop_min_all N=1000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("FT5 PQ pop_min_all N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("std PQ pop_min_all N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("FT5 PQ pop_max_all N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto base = make_pq(10'000);
        meter.measure([&] {
            auto pq = base;
            int sum = 0;
            while (auto p = pq.pop_max()) {
                sum += p->first;
                pq = std::move(p->second);
            }
            return sum;
    ...
    BENCHMARK_ADVANCED("std max-PQ pop_all N=10000")(
        Catch::Benchmark::Chronometer meter) {
...
TEST_CASE("Bench Std: IntervalIndex vs brute-force") {
    ...
    BENCHMARK_ADVANCED("FT5 Idx query_point N=1000")(
        Catch::Benchmark::Chronometer meter) {
        auto idx = make_idx(1000);
        meter.measure([&] { return idx.query_point(5000).size(); });
    };
    BENCHMARK_ADVANCED("vector query_point N=1000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_ivl_vec(1000);
        meter.measure([&] { return brute_query_point(v, 5000).size(); });
    };

    BENCHMARK_ADVANCED("FT5 Idx query_point N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto idx = make_idx(10'000);
        meter.measure([&] { return idx.query_point(5000).size(); });
    };
    BENCHMARK_ADVANCED("vector query_point N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_ivl_vec(10'000);
        meter.measure([&] { return brute_query_point(v, 5000).size(); });
    };

    BENCHMARK_ADVANCED("FT5 Idx query_point N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto idx = make_idx(100'000);
        meter.measure([&] { return idx.query_point(5000).size(); });
    };
    BENCHMARK_ADVANCED("vector query_point N=100000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    BENCHMARK_ADVANCED("FT5 Idx query_overlap N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto idx = make_idx(10'000);
        meter.measure([&] { return idx.query_overlap(4000, 6000).size(); });
    };
    BENCHMARK_ADVANCED("vector query_overlap N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_ivl_vec(10'000);
        meter.measure(
            [&] { return brute_query_overlap(v, 4000, 6000).size(); });
    };

    BENCHMARK_ADVANCED("FT5 Idx query_overlap N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto idx = make_idx(100'000);
        meter.measure([&] { return idx.query_overlap(4000, 6000).size(); });
    };
    BENCHMARK_ADVANCED("vector query_overlap N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_ivl_vec(100'000);
        meter.measure(
            [&] { return brute_query_overlap(v, 4000, 6000).size(); });
...
TEST_CASE("Bench Std: Persistence cost") {
    ...
    BENCHMARK_ADVANCED("FT5 10 snapshots N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto base = make_seq(N);
        meter.measure([&] {
            std::size_t total = 0;
            for (int k = 0; k < 10; ++k)
                total += base.insert(N / 2, k)
                             .size(); // O(log N) each, base unchanged
            return total;
        });
    };
    BENCHMARK_ADVANCED("vector 10 snapshots N=10000")(
        Catch::Benchmark::Chronometer meter) {
    ...
    // K=100 snapshots
    BENCHMARK_ADVANCED("FT5 100 snapshots N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto base = make_seq(N);
        meter.measure([&] {
            std::size_t total = 0;
    ...
    BENCHMARK_ADVANCED("vector 100 snapshots N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto base = make_vec(N);
        meter.measure([&] {
            std::size_t total = 0;
...
TEST_CASE("Bench Std: Sequential iteration (std wins)") {
    BENCHMARK_ADVANCED("FT5 iterate_sum N=1000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(1000);
        meter.measure([&] {
            // to_vector() materialises the tree (O(N)) before iterating
            int sum = 0;
            for (auto x : s.to_vector())
                sum += x;
            return sum;
        });
    };
    BENCHMARK_ADVANCED("vector iterate_sum N=1000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(1000);
        meter.measure([&] {
            int sum = 0;
    ...
    BENCHMARK_ADVANCED("FT5 iterate_sum N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(10'000);
        meter.measure([&] {
            int sum = 0;
    ...
    BENCHMARK_ADVANCED("vector iterate_sum N=10000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(10'000);
        meter.measure([&] {
            int sum = 0;
    ...
    BENCHMARK_ADVANCED("FT5 iterate_sum N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto s = make_seq(100'000);
        meter.measure([&] {
            int sum = 0;
    ...
    BENCHMARK_ADVANCED("vector iterate_sum N=100000")(
        Catch::Benchmark::Chronometer meter) {
        auto v = make_vec(100'000);
        meter.measure([&] {
            int sum = 0;

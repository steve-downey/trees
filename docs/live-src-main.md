...
```bash
out="trees/docs/live-src-main.md" && {
  ...
  while IFS= read -r f; do
    ...
    git show "HEAD:$f"
    printf '\n```\n\n'
  done < <(git ls-tree -r --name-only HEAD trees/src \
    | rg '^trees/src/' \
...
## smd/tree/finger_tree_interval_index_foldable.hpp
...
## smd/tree/finger_tree_interval_index_traversable.hpp

```cpp
// src/smd/tree/finger_tree_interval_index_traversable.hpp            -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
#ifndef INCLUDED_SMD_TREE_FINGER_TREE_INTERVAL_INDEX_TRAVERSABLE
#define INCLUDED_SMD_TREE_FINGER_TREE_INTERVAL_INDEX_TRAVERSABLE
...
## smd/tree/finger_tree_priority_queue_foldable.hpp
...
## smd/tree/finger_tree_priority_queue_traversable.hpp
...
## smd/tree/finger_tree_random_access_foldable.hpp
...
## smd/tree/finger_tree_random_access_traversable.hpp
...
## smd/tree/finger_tree_rope_foldable.hpp
...
## smd/tree/finger_tree_rope_traversable.hpp

```cpp
// src/smd/tree/finger_tree_rope_traversable.hpp                      -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
#ifndef INCLUDED_SMD_TREE_FINGER_TREE_ROPE_TRAVERSABLE
#define INCLUDED_SMD_TREE_FINGER_TREE_ROPE_TRAVERSABLE
...
## smd/typeclass/test/test_monoids.hpp
...
## smd/typeclass/test/test_optional_applicative.hpp

```cpp
// src/smd/typeclass/test/test_optional_applicative.hpp               -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
#ifndef INCLUDED_SMD_TYPECLASS_TEST_TEST_OPTIONAL_APPLICATIVE
#define INCLUDED_SMD_TYPECLASS_TEST_TEST_OPTIONAL_APPLICATIVE

#include <smd/typeclass/test/test_support.hpp>

#endif  // INCLUDED_SMD_TYPECLASS_TEST_TEST_OPTIONAL_APPLICATIVE
